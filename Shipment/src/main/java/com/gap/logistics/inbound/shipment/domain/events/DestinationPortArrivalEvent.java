...
public class DestinationPortArrivalEvent extends ShipmentEvent {
	
	
	public DestinationPortArrivalEvent(Date dateOfEvent, String location,
			String owner, List<Carton> cartons, List<SKU> skus, int quantity, boolean microBridgeFlag, String customsEntryNo) {
		super(dateOfEvent, "DPA", location, owner, cartons, skus);	
	}
