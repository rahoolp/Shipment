...
public class TrailerUnloadEvent extends ShipmentEvent {
	
	private String customsEntryNumber;
	
	public TrailerUnloadEvent(Date dateOfEvent, String location,
			String owner, List<Carton> cartons, List<SKU> skus, int quantity, boolean microBridgeFlag, String customsEntryNo) {
		super(dateOfEvent, "TU", location, owner, cartons, skus);	
