...
public class CustomsEntryEvent extends ShipmentEvent {
	
	private String customsEntryNumber;
	
	public CustomsEntryEvent(Date dateOfEvent, String location,
			String owner, List<Carton> cartons, List<SKU> skus, int quantity, boolean microBridgeFlag, String customsEntryNo) {
		super(dateOfEvent, "CE", location, owner, cartons, skus);	
